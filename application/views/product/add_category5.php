            ...
            <div class="card-body">
                ...
                <div class="tabs">
                    ...
                    <div class="tab-content">
                        <div id="category5" class="tab-pane active">
                            <form class="form-horizontal form-bordered" method="post" action="<?=base_url()?>Product/insert_category5">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 control-label text-lg-right pt-2">Category 2</label>
                                    <div class="col-lg-6">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 control-label text-lg-right pt-2">Category 3</label>
                                    <div class="col-lg-6">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 control-label text-lg-right pt-2">Category 4</label>
                                    <div class="col-lg-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="category5_name" />
                                    </div>
                                </div>
                                <div class="form-group row">
