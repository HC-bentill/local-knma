            ...
            <div class="card-body">
                ...
                <div class="tabs">
                    ...
                    <div class="tab-content">
                        <div id="category3" class="tab-pane active">
                            <form class="form-horizontal form-bordered" method="post" action="<?=base_url()?>Product/insert_category3" >
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="category3_name" />
                                    </div>
                                </div>
                                <div class="form-group row">
