                ...
                <div class="tabs">
                    ...
                    <div class="tab-content">
                        <div id="product" class="tab-pane active">
                            <form class="form-horizontal form-bordered" method="post" action="<?=base_url()?>Product/update_cat4" >
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 control-label text-lg-right pt-2" for="cat2name">Category 4 Name</label>
                                    <div class="col-lg-6">
                                        <input type="hidden" name="id" value="<?=$result[0]->id; ?>">
                                        <input type="text" class="form-control" name="cat4name" value="<?=$result[0]->name; ?>" required />
                                    </div>
                                </div>
