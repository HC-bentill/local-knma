                ...
                <div class="tabs">
                    ...
                    <div class="tab-content">
                        <div id="category1" class="tab-pane active">
                            <form class="form-horizontal form-bordered" method="post" action="<?=base_url()?>Product/insert_category1">
                                <div class="form-group row">
                                    <label class="col-lg-3 control-label text-lg-right pt-2">Product Name</label>
                                    <div class="col-lg-6">
                                        <select data-plugin-selectTwo class="form-control populate" name="productname">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="category1_name" />
                                    </div>
                                </div>
                                <div class="form-group row">
