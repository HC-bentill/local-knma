                ...
                <div class="tabs">
                    <ul class="nav nav-tabs">
                        <li class="nav-item active">
                            <a class="nav-link"><i class="fa fa-product-hunt"></i> Category 1</a>
                        </li>
                    </ul>
                    <div class="tab-content">
                        <div id="product" class="tab-pane active">
                            ...
                            <div class="form-group row">
                                <label class="col-lg-3 control-label text-lg-right pt-2" for="category1_name">Category 2 Name</label>
                                <div class="col-lg-6 padding-top-10">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <a href="<?=base_url()?>edit_cat2/<?=$result[0]->id; ?>" class="mb-1 mt-1 mr-1 btn btn-primary">Edit</a>
                                </div>
                                <div class="col-lg-3"></div>
                            </div>
                        </div>
