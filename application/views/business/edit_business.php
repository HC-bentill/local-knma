          	...
          	<main>
					...
					<form autocomplete="off" id="locform" method="post" action="<?=base_url()?>Business/edit_loc_data">
					   	...
					   	<div class="form-group row">
							...
							<div class="col-sm-4">
								...
								<input type="text" class="form-control" id="street_code" value="<?= $residence['street_code']?>" name="street_code" required>
			                </div>  
							<!-- <div class="col-sm-4">
				...
				<section class="section" id="content3">
					<form autocomplete="off" id="propform" method="post" action="<?=base_url()?>Business/edit_prop_data">
						<div class="form-group row">
							<div class="col-sm-3">
								<label class="control-label text-sm-right pt-2"><strong>Category:</strong></label>
								<select class="form-control" id="category" name="category" onchange="categoryLogic()" required>
									<option value="">SELECT OPTION</option>
									<option value="12" <?=$residence['category']== "12"?'selected == selected':''; ?>>BUSINESS PROPERTY</option>
									<option value="13" <?=$residence['category']== "13"?'selected == selected':''; ?>>RESIDENTIAL PROPERTY</option>
								</select>
							</div>
							<div class="col-sm-3">
							...
							<div class="col-sm-3" id="part1" style="display: none;">
								<label class="control-label text-sm-right pt-2"><strong>Temporary Building Type:</strong></label>
								<select data-plugin-selecttwo="" data-plugin-options="{ &quot;minimumResultsForSearch&quot;: 5 }"  id="detail_for_temp" name="detail_for_temp" class="form-control" autocomplete="off">
									<option value="">SELECT OPTION</option>
									<option value="Wooden Kiosk" <?=$residence['temporary_building']== "Wooden Kiosk"?'selected == selected':''; ?>>Wooden Kiosk</option>
									<option value="Metal Container" <?=$residence['temporary_building']== "Metal Container"?'selected == selected':''; ?>>Metal Container</option>
									<option value="Mobile Van/Car" <?=$residence['temporary_building']== "Mobile Van/Car"?'selected == selected':''; ?>>Mobile Van/Car</option>
									<option value="Table Top" <?=$residence['temporary_building']== "Table Top"?'selected == selected':''; ?>>Table Top</option>
								</select>
							</div>
							<div class="col-sm-3" id="part2" style="display:none">
							...
							<div class="col-sm-3" id="floor" style="display: none;">
							...
							<!-- <div class="col-sm-3" style="display: none;">
								...
								<input type="text" class="form-control" id="no_of_rooms" value="<?= $residence['no_of_rooms']?>" name="no_of_rooms" required/>
							</div> -->
						</div>
						<div class="form-group row" style="display:none;">
						...
						<div class="form-group row">
							...
							<div class="col-sm-4">
								<label class="control-label text-sm-right pt-2"><strong>Property Type/ Construction Material:</strong></label>
				...
				<section class="section" id="content4">
					<form autocomplete="off" id="facform" method="post" enctype="multipart/form-data" action="<?=base_url()?>Business/edit_facility_data">
				        ...
				        <div class="form-group row">
							...
							<div class="col-sm-4">
								<label class="control-label text-sm-right pt-2"><strong>Availability Of Telecom Network:</strong></label>
								<select data-plugin-selecttwo="" data-plugin-options="{ &quot;minimumResultsForSearch&quot;: 5 }" id="avail_of_telcom_network" name="avail_of_telcom_network" class="form-control" required>
									<option value="">SELECT OPTION</option>
									<option value="Yes" <?=$residence['avail_of_telcom_network']=='Yes'?'selected == selected':''; ?>>Yes</option>
									<option value="No" <?=$residence['avail_of_telcom_network']=='No'?'selected == selected':''; ?>>No</option>
								</select>
							</div>
							<div class="col-sm-4" style="display: none;" id="avail_of_telcom_network_yes">
								...
								<select data-plugin-selecttwo="" data-plugin-options="{ &quot;minimumResultsForSearch&quot;: 5 }" id="telcom_network" name="telcom_network" class="form-control" required>
									...
									<option value="Vodafone" <?=$residence['avail_of_telcom_network_yes']=='Vodafone'?'selected == selected':''; ?>>Vodafone</option>
									<option value="AirtelTigo" <?=$residence['avail_of_telcom_network_yes']=='AirtelTigo'?'selected == selected':''; ?>>AirtelTigo</option>
									<option value="Glo" <?=$residence['avail_of_telcom_network_yes']=='Glo'?'selected == selected':''; ?>>Glo</option>
								</select>
							</div>
				        </div>
				        <div class="form-group row"> 
							<div class="col-sm-4">
								<label class="control-label text-sm-right pt-2"><strong>Availability Of Electricity:</strong></label>
								<select data-plugin-selecttwo="" data-plugin-options="{ &quot;minimumResultsForSearch&quot;: 5 }" id="avail_of_electricity" name="avail_of_electricity" class="form-control" required>
									<option value="">SELECT OPTION</option>
									<option value="Yes" <?=$residence['avail_of_electricity']=='Yes'?'selected == selected':''; ?>>Yes</option>
									<option value="No" <?=$residence['avail_of_electricity']=='No'?'selected == selected':''; ?>>No</option>
								</select>
							</div>
							<div class="col-sm-4">
						...
						<div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <select data-plugin-selecttwo="" name="com_needs[]" class="form-control" autocomplete="off" multiple placeholder="Select Community needs">
                                    <?php
                                        $need = explode(',', $needs);
                                        foreach($com as $co){
                                            $name = $co->need;
