  ...
  <div class="col">
    <section class="card card-featured-bottom card-featured-primary form-wizard" id="w4">
      ...
      <div class="card-body">
        ...
        <form class="form-horizontal p-3" enctype="multipart/form-data" autocomplete="off" novalidate="novalidate" method="POST" action="<?=base_url()?>Business/add_business" id="submitForm">
            ...
            <div id="w4-profile" class="tab-pane">
              <div class="form-group row">
                ...
                <div class="col-sm-4">
                  ...
                  <input type="text" class="form-control" id="street_code" name="street_code" required>
                </div>
                <!-- <div class="col-sm-4">
              ...
              <div class="form-group row">
                <div class="col-sm-3">
                  ...
                  <select class="form-control" id="category" name="category" onchange="categoryLogic()" required>
                        <option value="">SELECT OPTION</option>
                        <option value="12">BUSINESS PROPERTY</option>
                        <option value="13">RESIDENTIAL PROPERTY</option>
                  </select>
                </div>
                <div class="col-sm-3">
                  <label class="control-label text-sm-right pt-2"><strong>Type Of Building:</strong></label>
                ...
                <!-- <div class="col-sm-3" style="display: none;">
                  ...
                  <input type="text" class="form-control" id="no_of_rooms" name="no_of_rooms" required/>
                </div> -->
              </div>
              <div class="form-group row">
                <div class="col-sm-4">
            ...
            <div id="w4-confirm" class="tab-pane">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-4 business_property" style="display: none;">
                  ...
                  <input type="text" class="form-control" id="no_of_occupants" name="no_of_occupants" autocomplete="off" required="" />
                </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-4">
                  ...
                  <input type="number" class="form-control" name="no_of_pwd"/>
                </div>
                <div class="col-sm-4">
                  <label class="control-label text-sm-right pt-2"><strong>Community Needs:</strong></label>
                  <select data-plugin-selecttwo="" id="tags" name="com_needs[]" class="form-control" autocomplete="off" multiple required placeholder="Select Community needs">
                      <option></option>
