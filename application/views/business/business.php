  ...
  <div class="row">
    <div class="col-md-12">
      <section class="card card-featured-bottom card-featured-primary">
        ...
        <div class="card-body">
          <form method="POST" action="<?= base_url('Business/search_business_property')?>" autocomplete="off">
          ...
          <table class="table table-bordered table-striped mb-0" id="datatable-tabletools-businessprop">
              <thead>
                <tr>
              ...
              <div class="modal-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      ...
                      <a href="<?=base_url("upload/upload_template/business_property_template.csv")?>" class="btn btn-warning" download>Download Template</a>
                    </div>
                </div>
              </div>
              <div class="modal-footer">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-4">
                    ...
                    <select data-plugin-selecttwo="" data-plugin-options="{ &quot;minimumResultsForSearch&quot;: 5 }" class="form-control" id="product" name="product" required>
                      <option data-target="" value="">All Bill Types</option> 
                      <?php foreach($products as $p){ ?>
                          <option data-target="<?= $p->target?>" value="<?= $p->id?>"><?=$p->name?></option>
                      <?php } ?>
                    </select>
                  </div>
                  <div class="col-sm-4">
