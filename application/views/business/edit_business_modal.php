            ...
            <div class="modal-body">
            	<div class="panel panel-primary">
				    <div class="panel-body">
				      <form name="basicform" id="basicform" method="post" action="<?=base_url()?>Business/edit_business_prop">
				        ...
				        <div id="sf1" class="frm">
							...
							<div class="form-group form-material floating row">
								<div class="col-sm-12 col-xs-12 col-md-6">
								   <input type="text" class="form-control" id="owner_locality_code" value="<?=$owner['locality_code']?>" name="owner_locality_code" autocomplete="off"  disabled=""/>
								   <label class="floating-label">Locality Code</label>
								</div>	
							</div>
							<div class="form-group form-material floating row">
								<div class="col-sm-12 col-xs-12 col-md-6">
								   <input type="text" class="form-control" id="owner_new_property_no" value="<?=$owner['new_property_no']?>" name="owner_new_property_no" autocomplete="off" disabled=""/>
								   <label class="floating-label">New Property No</label>
								</div>
								<div class="col-sm-12 col-xs-12 col-md-6">
								   <input type="text" class="form-control" id="owner_old_property_no" value="<?=$owner['old_property_no']?>" name="owner_old_property_no" autocomplete="off" disabled=""/>
								   <label class="floating-label">Old Property No</label>
								</div>	
							</div>
							<div class="form-group form-material floating row">
								<div class="col-sm-12 col-xs-12 col-md-6">
								   <input type="text" class="form-control" id="owner_zone_code" name="owner_zone_code" value="<?=$owner['zone_code']?>" autocomplete="off" disabled=""/>
								   <label class="floating-label">Zone Code</label>
								</div>
								<div class="form-group form-material floating row">
									<div class="col-sm-12 col-xs-12 col-md-6">
									   <input type="text" class="form-control" id="owner_houseno" name="owner_houseno" value="<?=$owner['houseno']?>" autocomplete="off" disabled=""/>
				        ...
				        <div id="sf3" class="frm" style="display: none;">
				          <fieldset>
				            ...
				            <div class="form-group form-material floating row">
								...
								<div class="col-sm-12 col-xs-12 col-md-6">
								   <input type="text" class="form-control" id="no_of_floors" name="no_of_floors" value="<?= $residence['no_of_floors']?>" autocomplete="off" required/>
				            ...
				            <div class="form-group form-material floating row">
								...
								<div class="col-sm-12 col-xs-12 col-md-6" id="t_no">
								   <select id="t_facility_no" name="t_facility_no" class="form-control" autocomplete="off" required>
										<option <?=$residence['t_facility_no']=='Yes'?'selected == selected':''; ?>>KVIP</option>
										<option <?=$residence['t_facility_no']=='No'?'selected == selected':''; ?>>Unapproved Location(Seashore,bush)</option>
									</select>
								   <label class="floating-label">Toilet Facilty Type</label>
								</div>	
							</div>
