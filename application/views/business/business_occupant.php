  ...
  <div class="row">
    <div class="col-md-12">
      <section class="card card-featured-bottom card-featured-primary">
        ...
        <div class="card-body">
          <form method="POST" action="<?= base_url('Business/search_busocc')?>" autocomplete="off">
                ...
                <div class="form-group m-form__group row">
                  ...
                  <div class="col-lg-3" id="search_box1" style="display:none;" required>
                    <select data-plugin-selecttwo="" data-plugin-options="{ &quot;minimumResultsForSearch&quot;: 5 }" class="form-control" id="search_option" name="search_option">
                        ...
                        <option <?=$search_option =='bus_code'?'selected == selected':''; ?> value="bus_code">Business Code</option>
                        <option <?=$search_option =='busprop_code'?'selected == selected':''; ?> value="busprop_code">Business Property Code</option>
                        <option <?=$search_option =='bus_name'?'selected == selected':''; ?> value="bus_name">Business Name</option>
                        <option <?=$search_option =='bus_pc'?'selected == selected':''; ?> value="bus_pc">Business Primary Contact</option>
                        <option <?=$search_option =='bus_sc'?'selected == selected':''; ?> value="bus_sc">Business Secondary Contact</option>
                        <option <?=$search_option =='bus_email'?'selected == selected':''; ?> value="bus_email">Business Email</option>
                        <option <?=$search_option =='bus_website'?'selected == selected':''; ?> value="bus_website">Business Website</option>
          ...
          <table class="table table-bordered table-striped mb-0" id="datatable-tabletools-businessocc">
             <thead>
                <tr>
