  ...
  <div class="page animsition" id="content">
    <div class="page-content container-fluid">
        <!-- search gproject nav bar starts here -->
          	...
          	<div class="col-sm-6" >
          			<?php if(has_permission($this->session->userdata('user_info')['id'],'edit residence')){ ?>
                  <button type="button" class="btn btn-outline btn-responsive btn-primary" onclick='do_checks()' data-toggle="modal" data-target=".example-modal-lg" style="margin-right: 2px; margin-top : 15px;">
                    ...
                    <span class="hidden-sm hidden-xs">Edit Residence</span>
                  </button>
                <?php }else{ ?>
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div align="center" class="col-md-4 col-xs-4">
                      <h3 class="ccdet"><?php echo $residence['res_code'];?></h3>
                    </div>
                    <div class="col-md-4 col-xs-4">
                ...
                <div class="row">
                  <div class="col-md-12">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-3 col-xs-3">
                          <h6 class="ccdet">Owner Cantact</h6>
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-3 col-xs-3">
                          ...
                          <?php if($residence['property_type'] !== 'Compound'){?>
                          ...
                          <table id="maintable" class="table table-hover width-full table-responsive">
                              ...
                              <tbody>
                                <?php foreach($result as $value):?>
                                  <tr>
                                    <td>
                                      <?php if(has_permission($this->session->userdata('user_info')['id'],'view household')){ ?>
                                      <a style="text-decoration: none;" href='<?= base_url().'view_household/'.$value->id?>'><?=$value->res_prop_code?></a>
                                      <?php }else{ ?>
                                      <a style="text-decoration: none;" onClick="has_permission()" href='#'><?=$value->res_prop_code?></a> 
                                      <?php } ?>  
                                    </td>
  ...
  <!-- End Page -->
  <?php $this->load->view("residence/edit_residence_modal.php");?>
