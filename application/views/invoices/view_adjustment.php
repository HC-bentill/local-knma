                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php }else{ ?>
                                    <a download="" href="<?= base_url().$value->file_path.$value->document?>"><span
                                            class="badge badge-success"><i class="fa fa-download"></i> Download
                                            Document</span></a>
                                    <?php } ?>
                                </td>
                                <td><?= $value->creator ?></td>
                                ...
                                <td>
                                    ...
                                    <?php }else if($value->approval_status == 'p'){?>
                                    <a
                                        onclick="confirm_modal('<?php echo $value->invoice_id ?>','<?php echo $value->adjustment_amount ?>','<?php echo $value->adjustment_type ?>','<?php echo $value->id ?>','<?php echo $value->approval_status?>','s','<?php echo $value->invoice_no?>','<?php echo $value->invoice_amount?>','<?php echo $value->invoice_type?>');"><i
                                            class="fa fa-check" style="color:green"></i></a> |
                                    <a
                                        onclick="confirm_modal('<?php echo $value->invoice_id ?>','<?php echo $value->adjustment_amount ?>','<?php echo $value->adjustment_type ?>','<?php echo $value->id ?>','<?php echo $value->approval_status?>','f','<?php echo $value->invoice_no?>','<?php echo $value->invoice_amount?>','<?php echo $value->invoice_type?>');"><i
                                ...
                                <td>
                                    <?php if($value->audit_approval == 's'){?>
                                    <a
                                        onclick="approval_modal('<?php echo $value->invoice_id ?>','<?php echo $value->adjustment_amount ?>','<?php echo $value->adjustment_type ?>','<?php echo $value->id ?>','<?php echo $value->approval_status?>','f','<?php echo $value->invoice_no?>','<?php echo $value->invoice_amount?>','<?php echo $value->invoice_type?>');"><i
                                            class="fa fa-times" style="color:red"></i></a>
                                    <?php }else if($value->audit_approval == 'p'){?>
                                    <a
                                        onclick="approval_modal('<?php echo $value->invoice_id ?>','<?php echo $value->adjustment_amount ?>','<?php echo $value->adjustment_type ?>','<?php echo $value->id ?>','<?php echo $value->approval_status?>','s','<?php echo $value->invoice_no?>','<?php echo $value->invoice_amount?>','<?php echo $value->invoice_type?>');"><i
                                            class="fa fa-check" style="color:green"></i></a> |
                                    <a
                                        onclick="approval_modal('<?php echo $value->invoice_id ?>','<?php echo $value->adjustment_amount ?>','<?php echo $value->adjustment_type ?>','<?php echo $value->id ?>','<?php echo $value->approval_status?>','f','<?php echo $value->invoice_no?>','<?php echo $value->invoice_amount?>','<?php echo $value->invoice_type?>');"><i
                                            class="fa fa-times" style="color:red"></i></a>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-4">
                            ...
                            <input type="text" class="form-control" id="adjustment_type_name"
                                name="adjustment_type_name" readonly>
                        </div>
                        <div class="col-sm-6">
                            <label class="control-label text-sm-right pt-2" id="reason_text"><strong>Adjustment
                                    Reason:</strong></label>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <label class="control-label text-sm-right pt-2"><strong>Invoice Amount:</strong></label>
                            <input type="number" class="form-control" id="invoiceamount_approval" name="invoiceamount"
                                readonly>
                        </div>
                        <div class="col-sm-4">
                            <label class="control-label text-sm-right pt-2"><strong>Adjustment Amount:</strong></label>
                            <input type="number" class="form-control" id="adjustment_amount_approval"
                                name="adjustment_amount" readonly>
                        </div>
                    </div>
                    <div class="form-group row" style="display:none">
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" class="form-control" id="approval_status_approval"
                                name="approval_status">
                            <input type="text" class="form-control" id="invoice_type_approval" name="invoice_type">
                            <input type="text" class="form-control" id="adjustment_type_approval"
                    ...
                    <div class="form-group row">
                        <div class="col-sm-4">
                            <label class="control-label text-sm-right pt-2"><strong>Adjustment Type:</strong></label>
                            <input type="text" class="form-control" id="adjustment_type_name_approval"
                                name="adjustment_type_name" readonly>
                        </div>
                        <div class="col-sm-6">
                            <label class="control-label text-sm-right pt-2" id="reason_text_approval"><strong>Adjustment
                                    Reason:</strong></label>
