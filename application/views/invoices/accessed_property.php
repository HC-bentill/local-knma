                      ...
                      <div id="product" class="tab-pane active">
                          <form class="form-horizontal form-bordered" method="post" action="<?=base_url()?>Invoice/insert_accessed_property" >
                            <div class="form-group row">
                              ...
                              <div class="form-group row">
                                  <label class="col-lg-3 control-label text-lg-right pt-2">Choose Business Property</label>
                                  <div class="col-lg-6">
                                      <select data-plugin-selectTwo class="form-control" name="property_id" id="property_id" required>
                                        <option value="">Select an option</option>
                                        <?php foreach($result as $r){ ?>
                                          <?php $owner = business_owner_details($r->id); ?>
                                          <option value="<?= $r->id?>"><?=$r->buis_prop_code.' - '.$owner['firstname'].' '.$owner['lastname'].' - '. $owner['primary_contact']?></option>
                                        <?php } ?>
                                      </select>
                                  </div>
                              </div>
                              <div class="form-group row">
                                  <label class="col-lg-3 control-label text-lg-right pt-2" for="rateable_amount">Rateable Amount</label>
                                  <div class="col-lg-6">
                                      <input type="number" step=".01" class="form-control" name="rateable_amount" required />
                                  </div>
                              </div>
                              <div class="form-group row">
                                  <label class="col-lg-3 control-label text-lg-right pt-2" for="rate">Rate</label>
                                  <div class="col-lg-6">
                              ...
                              <div class="form-group row" style="display:none;">
                                  ...
                                  <div class="col-lg-6">
                                      <input type="number" value="2" class="form-control" name="target" required />
                                  </div>
                              </div>
                              <div class="form-group row">
