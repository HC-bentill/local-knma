            ...
            <div class="card-body">
              <div class="tabs">
                  <ul class="nav nav-tabs">
                      <li class="nav-item">
                          <a class="nav-link" href="<?=base_url()?>onetime_invoice/view/<?=$this->uri->segment(2)?>"><i class="fa fa-btc"></i>Invoices</a>
                      </li>
                      <li class="nav-item">
                          <a class="nav-link" href="<?=base_url()?>onetime_invoice_payment/<?=$this->uri->segment(2)?>"><i class="fa fa-usd"></i>Payment</a>
                      </li>
                      <li class="nav-item active">
                          <a class="nav-link" href="<?=base_url()?>onetime_invoice_transaction/<?=$this->uri->segment(2)?>"><i class="fa fa-money"></i>Transactions</a>
                      </li>
                      <li class="nav-item">
                          <a class="nav-link" href="<?=base_url()?>onetime_invoice_adjustment/<?=$this->uri->segment(2)?>"><i class="fa fa-adjust"></i>Adjustment</a>
                      </li>
                  </ul>
                            ...
                            <tbody>
                              <?php foreach($transaction as $value):?>
                                ...
                                <tr>
                                  ...
                                  <td><a href="<?=base_url()?>onetime_invoice_transaction/receipt/<?= $value->transaction_id?>">View Receipt</a></td>
                                </tr>
                              <?php endforeach; ?>
                            </tbody>
                          </table>
