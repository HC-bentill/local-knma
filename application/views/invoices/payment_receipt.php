            ...
            <div class="card-body">
                <div class="invoice">
                    ...
                    <table class="table table-responsive-md invoice-items" style="white-space:normal;">
                        ...
                        <tbody>
                            <tr>
                                <td><?php echo $receipt_txn->payment_type . ' of ' . $result->name; ?></td>
                                ...
                                <table class="table h6 text-dark">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td width="40%" class="text-left">GHS <?php $bal = (float)number_format((float)$result->invoice_amount, 2, '.', '') - (float)number_format((float)$result->amount_paid, 2, '.', ''); echo number_format($bal , 2, '.', ',');?></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                ...
                <div class="text-right mr-4">
                    <a href="<?=base_url()?>invoice_transaction/print_receipt/<?= $receipt_txn->transaction_id ?>" target="_blank" class="btn btn-primary ml-3"><i class="fa fa-print"></i> Print</a>
                </div>
            </div>
