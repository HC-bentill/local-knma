	...
	<body>
		<div class="invoice receipt_preview">
			<header class="clearfix">
				<div class="row">
					<div class="col-sm-6 mt-3">
						...
						<h6 class="h4 m-0 text-dark font-weight-bold" style="font-size:90%;">#<?=$result->invoice_id ?></h6>
            ...
            <table class="table table-responsive-md invoice-items" style="white-space:normal;">
                ...
                <tbody>
                    <tr>
                        <td><?php echo $receipt_txn->payment_type . ' of ' . $result->revenue_product_name; ?></td>
                        ...
                        <table class="table h6 text-dark">
                            <tbody>
                                <tr>
                                    ...
                                    <td width="50%" class="text-left"><?= 'GHS '.number_format((float)$result->amount, 2, '.', ',');?></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td width="50%" class="text-left">GHS <?php $bal = (float)number_format((float)$result->amount, 2, '.', '') - (float)number_format((float)$result->amount_paid, 2, '.', ''); echo number_format($bal , 2, '.', ',');?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
